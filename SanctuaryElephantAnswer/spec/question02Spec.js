describe("Question Two",()=> {
      describe("adding the four ElephantOwners", () => {
        ...
        it("should have correctly set details for each ElephantOwner", () => {
            ...
            expect(anElephantOwner.birthDate).toEqual(new Date(1980, 9, 7))
            ...
            expect(anElephantOwner.birthDate).toEqual(new Date(1990, 4, 9))
            ...
            expect(anElephantOwner.birthDate).toEqual(new Date(1986, 7, 31))
            ...
            expect(anElephantOwner.birthDate).toEqual(new Date(1995, 8, 2))
        })
    })
})